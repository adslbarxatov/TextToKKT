...
доступны функции чтения статуса ФН, а также чтения отдельного документа. При этом полное считывание ФН, обмен с ОФД, формирование дампов и аналитический
...
Программа FNArc, разработанная ЗАО «Атлас-карт» и доступная в ЛК ФНС, программа FNTransfer и программа FNRun производства
