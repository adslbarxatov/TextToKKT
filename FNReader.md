...
Программа FNArc, разработанная ЗАО «Атлас-карт», программа FNTransfer, доступная в ЛК ФНС, и программа FNRun производства обеспечивают считывание архива ФН в полном соответствии с законодательством. Однако в некоторых режимах работы приложение может работать медленнее, чем программа FNReader. Кроме того, предусмотренная законом выгрузка представляет собой двоичный файл, просмотреть который штатными средствами операционной системы или самой программой не представляется возможным.
