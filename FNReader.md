...
7. Открытие и закрытие смены и закрытие архива ФН текущей датой или датой последнего документа ФН.

8. Чтение выгрузок архивов ФН в форматах `.fnc` и `.fsd`.

9. Формирование выгрузки уведомлений о реализации маркированного товара (при работе в автономном режиме)
...
- Собственный формат программы FNReader (v4 – v9, `.fsd`);
