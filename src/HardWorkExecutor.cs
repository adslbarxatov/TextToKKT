...
#else
			this.BackColor = Color.FromArgb (11 * ProgramDescription.MasterBackColor.R / 10,
				11 * ProgramDescription.MasterBackColor.G / 10, 11 * ProgramDescription.MasterBackColor.B / 10);
